...
--
-- Table structure for table `rishav123`
--

CREATE TABLE `rishav123` (
  `userId` int(11) DEFAULT NULL,
  `id` int(11) DEFAULT NULL,
  `title` varchar(255) DEFAULT NULL,
  `body` varchar(255) DEFAULT NULL
...
--
-- Dumping data for table `rishav123`
--

INSERT INTO `rishav123` (`userId`, `id`, `title`, `body`) VALUES
...
(1, 'rishavcse1', '$2y$10$BIDYlOrOyoRZVQC74BuQ4eMULMcPslXJnOMXttt4HKVFezDVKapCm', '2021-09-21 16:42:26'),
(2, 'Rishab', '$2y$10$rXfxniUxhht07XYMsBEFI.ayOsmPcePCTdbk2A.zQ2YA9Rd7.FOQS', '2021-09-21 16:48:50');
